...
def main() -> None:
    ...
    for character_id, config in CHARACTERS.items():
        ...
        edit_reference.save(OUTPUT_DIR / f"{character_id}-eye-removal-reference.webp")
        eye_reference.save(OUTPUT_DIR / f"{character_id}-eye-style-reference.webp")
    ...
    sheet.save(OUTPUT_DIR / "_references-sheet.webp")
